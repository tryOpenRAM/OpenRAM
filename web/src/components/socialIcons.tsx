...
/** Social links. Ticker: $HEDGE · site hedgebots.trade · X @Hedgebots. */
export const SOCIAL_LINKS = {
  pons: "https://www.ponsfamily.com/",
  x: "https://x.com/Hedgebots",
  github: "https://github.com/ctrlshifthash/HedgeBots",
  site: "https://hedgebots.trade",
};
